...
export default function FaqSection({ lang }: FaqSectionProps) {
  ...
  const faqItems = useMemo<FAQItem[]>(() => [
    ...
    { id: 'cancellation', category: 'policies', icon: ShieldCheck,
      ...
      aEs: 'Las reservas confirmadas son no reembolsables. No se permite cancelación gratuita porque el inventario se sincroniza al instante con Booking, Expedia, Airbnb y otras plataformas.',
      aEn: 'Confirmed bookings are non-refundable. Free cancellation is not available because inventory is synchronized instantly with Booking, Expedia, Airbnb, and other channels.',
      aFr: 'Les réservations confirmées sont non remboursables. L\'annulation gratuite n\'est pas disponible car l\'inventaire est synchronisé en temps réel avec Booking, Expedia, Airbnb et d\'autres canaux.',
      aAr: 'الحجوزات المؤكدة غير قابلة للاسترداد. لا يتوفر إلغاء مجاني لأن المخزون يتزامن فوراً مع Booking وExpedia وAirbnb ومنصات أخرى.' },
